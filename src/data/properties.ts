...
export const properties: Property[] = [
  ...
  {
    id: "9",
    title: "Piso en zona céntrica de Granada",
    type: "vivienda",
    operation: "venta",
    saleType: "ocupado",
    price: 38000,
    ...
    features: ["Céntrico", "Fachada rehabilitada", "Buen potencial"],
    images: [property1],
    profitability: 19.8,
    reference: "IKE-009",
    hasElevator: true,
  ...
  // ── Cataluña ──
  {
    ...
    features: ["Finca regia", "Techos 3.5m", "Mosaicos originales", "Terraza"],
    images: [property1],
    profitability: 14.5,
    reference: "IKE-014",
    hasTerrace: true,
  ...
  // ── Comunidad Valenciana ──
  {
    ...
    features: ["Zona revalorización", "Cerca playa", "Techos altos"],
    images: [property2],
    profitability: 25.6,
    reference: "IKE-017",
    year: 1960,
