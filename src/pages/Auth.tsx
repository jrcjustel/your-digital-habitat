      ...
      <div className="container mx-auto px-4 py-16 flex items-center justify-center min-h-[70vh]">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <img src={ikesaLogo} alt="ikesa" className="h-10 mx-auto mb-4" />
            ...
            <CardDescription>
              {mode === "login" && "Accede a tu área personal de ikesa"}
              {mode === "register" && "Regístrate para guardar favoritos y crear alertas"}
            ...
            {mode === "forgot" ? (
              ...
              <>
                ...
                <form onSubmit={mode === "login" ? handleLogin : handleRegister} className="space-y-4">
                  ...
                  {mode === "login" && (
                    <button type="button" onClick={() => setMode("forgot")} className="text-sm text-accent hover:underline">
                ...
                <p className="text-center text-sm text-muted-foreground">
                  {mode === "login" ? (
                    <>¿No tienes cuenta?{" "}<button onClick={() => setMode("register")} className="text-accent hover:underline font-medium">Regístrate</button></>
                  ) : (
                    <>¿Ya tienes cuenta?{" "}<button onClick={() => setMode("login")} className="text-accent hover:underline font-medium">Inicia sesión</button></>
                  )}
                </p>
              </>
            )}
