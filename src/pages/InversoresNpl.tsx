  ...
  <div className="min-h-screen bg-background">
    ...
    <section className="bg-gradient-to-b from-primary to-primary/90 text-primary-foreground py-14 md:py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <span className="text-xs font-bold uppercase tracking-widest text-accent mb-4 block">Inversión en NPL</span>
        <h1 className="font-heading text-3xl md:text-4xl font-bold mb-4">
          Compra de crédito impagado (NPL)
        </h1>
        <p className="text-primary-foreground/80 text-base md:text-lg max-w-2xl mb-8">
          Adquiere derechos de crédito hipotecario impagado subrogándote en la posición del acreedor.
          Accede a descuentos significativos sobre la deuda pendiente y obtén la garantía inmobiliaria
