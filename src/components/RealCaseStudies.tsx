...
const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    type: "cesion",
    typeLabel: "Cesión de Remate",
    title: "Ático duplex en Sevilla Este",
    location: "Sevilla, Andalucía",
    purchasePrice: 95000,
    marketValue: 185000,
    totalInvestment: 127000,
    salePrice: 172000,
    netProfit: 45000,
    roi: 35.4,
    timeMonths: 11,
    steps: [
      { label: "Cesión firmada", detail: "Derecho de remate adquirido por 95.000 €", months: 0 },
      { label: "Posesión obtenida", detail: "Inmueble libre — entrega de llaves sin incidencias", months: 2 },
      { label: "Reforma parcial", detail: "Baños, climatización y pintura — 18.000 €", months: 5 },
      { label: "Venta cerrada", detail: "Vendido a 172.000 € a familia joven", months: 11 },
    ],
    highlight: "Ático adquirido al 51% del valor de mercado con ROI del 35,4%",
  },
  {
    id: "case-2",
    type: "npl",
  ...
  },
  {
    ...
    type: "npl",
    typeLabel: "NPL — Compra de crédito",
    title: "Vivienda unifamiliar en Alicante",
    location: "Alicante, C. Valenciana",
    purchasePrice: 31000,
    marketValue: 92000,
    ...
    timeMonths: 14,
    steps: [
      { label: "Compra de crédito", detail: "NPL adquirido por 31.000 € (34% de deuda pendiente)", months: 0 },
      { label: "Ejecución hipotecaria", detail: "Subasta desierta — adjudicación al acreedor", months: 8 },
      { label: "Toma de posesión", detail: "Inmueble vacío, posesión inmediata", months: 9 },
      { label: "Venta finalizada", detail: "Vendido a particular por 84.000 € tras home staging", months: 14 },
    ],
    highlight: "ROI del 69,7% — crédito comprado al 34% de la deuda con adjudicación rápida",
  },
  {
    id: "case-3",
    type: "ocupado",
  ...
  },
  {
    ...
    type: "ocupado",
    typeLabel: "Inmueble Ocupado",
    title: "Bajo comercial 85 m² en Barcelona",
    ...
    timeMonths: 20,
    steps: [
      { label: "Adquisición", detail: "Compra del local ocupado por 68.000 € (-56% vs mercado)", months: 0 },
      { label: "Negociación directa", detail: "Acuerdo de desalojo con compensación económica", months: 4 },
      { label: "Acondicionamiento", detail: "Reforma y adecuación del local — 16.000 €", months: 8 },
      { label: "Venta cerrada", detail: "Vendido a franquicia por 142.000 €", months: 20 },
    ],
    highlight: "Descuento del 56% y resolución extrajudicial en solo 4 meses",
  },
];
